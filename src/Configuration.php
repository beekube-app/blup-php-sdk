...
class Configuration
{
     ...
     * @var string
     */
    protected string $host = 'https://mellifera.beekube.com';
     ...
     * @var string
     */
    protected string $userAgent = 'Beekube-Blup/1.0.2';
    ...
    {
        $report  = 'PHP SDK (Beekube\BlupSDK) Debug Report:' . PHP_EOL;
    ...
    public function getHostSettings(): array
    {
        return [
            [
                "url" => "https://mellifera.beekube.com",
